...
const mockData = {
  ...
  grouped: {
    valley: [{ code: 'BK1682', name: 'AI算力', stage: '波谷', vl_score: 4, pk_score: 0, bias20: -6.3, change_5d: -1.2, change_1d: -0.5, volume_ratio: 0.52, mainline_rank: 3, mainline_badge: 'gold', volume_signal: 'shrink', entry_window: true, vs_market_5d: 3.2, vs_market_20d: -2.1, historical_gain: 18.5, last_peak_date: '2026-05-15', last_trough_date: '2026-05-28', cycle_days: 23, cycle_count: 2, related_stocks: ['中际旭创'], related_count: 1, related_codes: ['000308'], stock_count: 35, wave_data: [], annotations: [], klines: [], chart_annotations: [] }],
    mid: [],
    declining: [],
  },
